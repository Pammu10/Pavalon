        ...
        <div className="animate-fadeIn flex flex-col items-center justify-center space-y-8 min-h-screen">
            ...
            <Card className="w-full max-w-md">
                <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                    <h2 className="font-cinzel text-3xl text-center text-white">{isLogin ? 'Login' : 'Register'}</h2>
                    ...
                    <button type="button" onClick={() => setIsLogin(!isLogin)} className="text-center text-slate-400 hover:text-yellow-500 transition">
