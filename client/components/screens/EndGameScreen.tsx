        ...
        {players.map((player) => {
          ...
          return (
            <div
              key={player.id}
              className={cn(
                "relative flex items-center p-2 rounded-xl text-white shadow-2xl border backdrop-blur-md",
                isGood ? "bg-blue-950/30 border-blue-500/50 shadow-blue-500/20" : "bg-red-950/30 border-red-500/50 shadow-red-500/20",
            ...
            >
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0 text-left">
                  <p className="font-eaglelake text-sm sm:text-xl font-bold text-white tracking-wide truncate">
                    {player.name}
                  </p>
                  <p className="font-eaglelake text-xs sm:text-base text-yellow-300 truncate">
              ...
              <div className="flex-shrink-0 px-2 sm:px-4">
                <p className={cn(
                    "font-eaglelake text-sm sm:text-lg font-black tracking-wider",
                    isGood ? "text-blue-300" : "text-rose-400"
                )}>
